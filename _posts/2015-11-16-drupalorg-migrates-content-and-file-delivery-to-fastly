...
<img src="/files/fastly-logo_0.png" alt="Fastly logo" class="right" width="250"/>We are so stoked to announce our partnership with <a href="http://fastly.us/1H1mcCF">Fastly</a>. Fastly is now serving up all of our traffic from the *.drupal.org domain Drupal sites and related services.
...
<img src="/files/fastly_global_delivery_network_pop_map_v25_11.05.15.png" alt="Global network" />
...
<img src="/files/caching-basics-1st-request-withshielding.png" alt="Caching basics" />
...
<img src="/files/caching-basics-subsequent-request-withshielding.png" alt="Caching basics, subsequent requests" />
...
<img src="/files/fastly-updates-performance.gif" alt="Really cool animated GIF showing updates traffic" />
