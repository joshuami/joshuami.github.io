...
/* radix:pagination */
class __TwigTemplate_4dba72b03408d7ec9e1ab08f90da9712 extends Template
{
...
";
    ...
    <ul
      class=\"pagination pager__items js-pager__items d-flex flex-wrap ";
            // line 38
            yield ((($context["size"] ?? null)) ? ($this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ("pagination-" . ($context["size"] ?? null)), "html", null, true)) : (""));
            yield " ";
      ...
      ";
            // line 101
            yield "      ";
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "next", [], "any", false, false, true, 101)) {
                // line 102
