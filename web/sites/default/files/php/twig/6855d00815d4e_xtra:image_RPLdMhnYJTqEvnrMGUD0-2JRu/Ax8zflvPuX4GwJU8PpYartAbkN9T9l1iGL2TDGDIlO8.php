...
/* xtra:image */
class __TwigTemplate_7bffdabaf1c2d9b4aeb5192496f45082 extends Template
{
...
($context["align"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (Twig\Extension\CoreExtension::join((($_v1 = ($context["align_classes"] ?? null)) && is_array($_v1) || $_v1 instanceof ArrayAccess && in_array($_v1::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v1[($context["align"] ?? null)] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["align_classes"] ?? null), ($context["align"] ?? null), [], "array", false, false, true, 49)), " ")) : ("")), (((($tmp =             // line 50
($context["responsive"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("img-fluid") : ("")), (((($tmp =             // line 51
($context["thumbnails"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("img-thumbnail") : ("")), (((($tmp =             // line 52
($context["rounded"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("rounded-circle") : (""))], ((            // line 53
