...
/* xtra:node */
class __TwigTemplate_3732db36dff4fe1f499562c9f888d49e extends Template
{
...
($context["node"] ?? null), "isPublished", [], "method", false, false, true, 40)) ? ("node--unpublished") : ("")), \Drupal\Component\Utility\Html::getClass(CoreExtension::getAttribute($this->env, $this->source,             // line 41
...
";
    ...
    public function block_node_title(array $context, array $blocks = []): iterable
    {
        ...
        if ( !($context["page"] ?? null)) {
            ...
            yield "      ";
            // line 68
            yield from $this->loadTemplate("radix:heading", "xtra:node", 68)->unwrap()->yield(CoreExtension::merge($context, ["content" => ((            // line 69
