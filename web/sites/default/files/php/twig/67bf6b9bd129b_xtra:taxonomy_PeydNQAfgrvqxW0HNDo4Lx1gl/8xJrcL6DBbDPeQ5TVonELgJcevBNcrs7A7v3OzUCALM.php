...
/* xtra:taxonomy */
class __TwigTemplate_264c22bdb9c0ffe1980c4e9cc4cdf706 extends Template
{
...
";
            // line 31
            $context["taxonomy_classes"] = Twig\Extension\CoreExtension::merge(["taxonomy", (( !CoreExtension::getAttribute($this->env, $this->source,             // line 33
($context["term"] ?? null), "isPublished", [], "method", false, false, true, 33)) ? ("term--unpublished") : ("")), \Drupal\Component\Utility\Html::getClass(CoreExtension::getAttribute($this->env, $this->source,             // line 34
  ...
  ";
    ...
    public function block_taxonomy_title(array $context, array $blocks = []): iterable
    {
        ...
        if ((($context["name"] ?? null) &&  !($context["page"] ?? null))) {
            ...
            yield "      ";
            // line 59
            yield from $this->loadTemplate("radix:heading", "xtra:taxonomy", 59)->unwrap()->yield(CoreExtension::merge($context, ["content" => ((            // line 60
