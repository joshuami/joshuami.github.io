...
/* xtra:page */
class __TwigTemplate_033c7c36a880698d542a3878aa01d7ff extends Template
{
...
($context["page_utility_classes"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (($context["page_utility_classes"] ?? null)) : ([])));
        // line 13
...
";
    ...
    public function block_alerts(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 14
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "alerts", [], "any", false, false, true, 14)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 15
            yield "  ";
...
";
    ...
    public function block_page_navigation(array $context, array $blocks = []): iterable
    {
        ...
        // line 20
        yield "    ";
        yield from $this->load("xtra:page-navigation", 20)->unwrap()->yield($context);
        // line 21
        yield "  ";
        yield from [];
    }
    ...
    public function block_page_content(array $context, array $blocks = []): iterable
    {
        ...
        // line 24
        yield "    ";
        yield from $this->load("xtra:page-content", 24)->unwrap()->yield($context);
        // line 25
        yield "  ";
        yield from [];
    }
    ...
    public function block_page_footer(array $context, array $blocks = []): iterable
    {
        ...
        // line 28
        yield "    ";
        yield from $this->load("xtra:page-footer", 28)->unwrap()->yield($context);
        // line 29
        yield "  ";
        yield from [];
    }
