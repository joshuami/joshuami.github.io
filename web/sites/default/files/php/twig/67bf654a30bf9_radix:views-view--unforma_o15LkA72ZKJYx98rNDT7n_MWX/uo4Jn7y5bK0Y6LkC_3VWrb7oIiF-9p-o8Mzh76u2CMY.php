...
class __TwigTemplate_678020c7e9f734310553a504c3e726ba extends Template
{
...
";
    ...
    public function block_views_unformatted_title(array $context, array $blocks = []): iterable
    {
        ...
        if (($context["title"] ?? null)) {
            ...
            yield "    ";
            // line 21
            yield from $this->loadTemplate("radix:heading", "radix:views-view--unformatted", 21)->unwrap()->yield(CoreExtension::merge($context, ["heading_html_tag" => "h3", "content" =>             // line 23
($context["title"] ?? null)]));
            // line 26
            yield "  ";
        }
    ...
    public function block_views_unformatted_rows(array $context, array $blocks = []): iterable
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
            ...
            yield "    ";
            // line 32
            $context["row_classes"] = Twig\Extension\CoreExtension::merge([((            // line 33
($context["default_row_class"] ?? null)) ? ("views-row") : (""))], ((            // line 34
