...
class __TwigTemplate_7ada078af5aa9511eb5a6a1a7a90a103 extends Template
{
...
($context["media"] ?? null), "bundle", [], "method", false, false, true, 4))), (( !CoreExtension::getAttribute($this->env, $this->source,         // line 5
($context["media"] ?? null), "isPublished", [], "method", false, false, true, 5)) ? ("media--unpublished") : ("")), ((        // line 6
($context["view_mode"] ?? null)) ? (("media--view-mode-" . \Drupal\Component\Utility\Html::getClass(($context["view_mode"] ?? null)))) : (""))];
  ...
  ";
      ...
      ";
                ...
                // line 22
                yield "      ";
                if (CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "hasPermission", ["edit any image media"], "method", false, false, true, 22)) {
                    // line 23
