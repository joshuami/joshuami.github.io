...
class __TwigTemplate_ac08b7146bd3f10f8fcf0131e21eff45 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 29
        yield from $this->load("xtra:block", 29)->unwrap()->yield(CoreExtension::merge($context, ["block_utility_classes" => ["block--system-main"]]));
        yield from [];
    }
