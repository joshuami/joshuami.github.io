...
";
            // line 10
            yield from $this->loadTemplate("xtra:page-navigation", "xtra:page-navigation", 10, "1624026063")->unwrap()->yield(CoreExtension::merge($context, ["container" => "fixed", "navbar_theme" => "dark", "navbar_expand" => "sm", "navbar_utility_classes" => ["justify-content-between", "border", "border-primary", "border-0", "border-bottom", "border-4"]]));
            // line 46
            yield "
";
            yield from [];
...
/* xtra:page-navigation */
class __TwigTemplate_968a116f7f804557404aee2c800f193f___1624026063 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
    ...
    public function block_branding(array $context, array $blocks = []): iterable
    {
        ...
        // line 25
        yield "    ";
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "navbar_branding", [], "any", false, false, true, 25)) {
            // line 26
            yield "      ";
    ...
    public function block_left(array $context, array $blocks = []): iterable
    {
        ...
        // line 31
        yield "    ";
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "navbar_left", [], "any", false, false, true, 31)) {
            // line 32
    ...
    public function block_right(array $context, array $blocks = []): iterable
    {
        ...
        // line 39
        yield "    ";
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "navbar_right", [], "any", false, false, true, 39)) {
            // line 40
