...
/* xtra:block */
class __TwigTemplate_9c7bc9fd2da61a99c0624aa33f128691 extends Template
{
...
($context["plugin_id"] ?? null))), (((($tmp =             // line 43
($context["layout"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("layout--" . \Drupal\Component\Utility\Html::getClass(($context["layout"] ?? null)))) : ("")), (((($tmp =             // line 44
($context["bundle"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("block--" . \Drupal\Component\Utility\Html::getClass(($context["bundle"] ?? null)))) : ("")), (((($tmp =             // line 45
($context["id"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("block--" . \Drupal\Component\Utility\Html::getClass(Twig\Extension\CoreExtension::replace(($context["id"] ?? null), ["_" => "-"])))) : (""))], ((            // line 46
...
";
    ...
    public function block_block_label(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp = ($context["label"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            yield "      ";
            // line 63
            yield from $this->load("radix:heading", 63)->unwrap()->yield(CoreExtension::merge($context, ["heading_attributes" =>             // line 64
