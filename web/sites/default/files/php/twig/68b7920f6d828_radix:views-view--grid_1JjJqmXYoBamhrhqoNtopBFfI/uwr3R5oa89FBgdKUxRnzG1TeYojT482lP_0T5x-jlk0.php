...
class __TwigTemplate_8001ca0a3ecaa41a2fddadb82790e22f extends Template
{
...
";
        // line 35
        $context["row_classes"] = (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "row_class_default", [], "any", false, false, true, 35)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (["views-row", (((CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "alignment", [], "any", false, false, true, 35) == "horizontal")) ? ("clearfix") : (""))]) : ([]));
        // line 36
        $context["col_classes"] = (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "col_class_default", [], "any", false, false, true, 36)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (["views-col", (((CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "alignment", [], "any", false, false, true, 36) == "vertical")) ? ("clearfix") : (""))]) : ([]));
        // line 37
        yield "
";
        // line 38
