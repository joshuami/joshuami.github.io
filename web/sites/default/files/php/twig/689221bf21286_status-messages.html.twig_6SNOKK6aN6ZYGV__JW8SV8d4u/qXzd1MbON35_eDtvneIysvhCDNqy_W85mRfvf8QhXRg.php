...
class __TwigTemplate_efa67cd73e717e882c85eb65b529645c extends Template
{
...
";
    ...
    ";
            // line 31
            yield from $this->load("themes/custom/xtra/templates/misc/status-messages.html.twig", 31, "1067059070")->unwrap()->yield(CoreExtension::merge($context, ["type" => (($_v1 =             // line 32
...
/* themes/custom/xtra/templates/misc/status-messages.html.twig */
class __TwigTemplate_efa67cd73e717e882c85eb65b529645c___1067059070 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->load("radix:alert", 31);
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        // line 35
        yield "        ";
        if ((($tmp = (($_v2 = ($context["status_headings"] ?? null)) && is_array($_v2) || $_v2 instanceof ArrayAccess && in_array($_v2::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v2[($context["type"] ?? null)] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["status_headings"] ?? null), ($context["type"] ?? null), [], "array", false, false, true, 35))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 36
