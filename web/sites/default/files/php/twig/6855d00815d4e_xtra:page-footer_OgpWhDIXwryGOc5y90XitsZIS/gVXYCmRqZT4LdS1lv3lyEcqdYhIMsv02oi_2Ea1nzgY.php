...
/* xtra:page-footer */
class __TwigTemplate_83ed42a2accac6796b9ee3d349452467 extends Template
{
...
";
            // line 17
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "footer", [], "any", false, false, true, 17)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 18
                yield "  <footer ";
