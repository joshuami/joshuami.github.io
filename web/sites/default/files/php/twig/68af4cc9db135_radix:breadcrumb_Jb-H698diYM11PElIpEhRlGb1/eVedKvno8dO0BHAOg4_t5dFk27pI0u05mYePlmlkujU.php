...
/* radix:breadcrumb */
class __TwigTemplate_411d41e22f3f3b39905092c1f91abbdd extends Template
{
      ...
      <ol ";
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar((((($tmp =  !CoreExtension::getAttribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 22)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("active") : ("")));
                yield "\">
            ";
                // line 23
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 23)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 24
                    yield "              <a href=\"";
