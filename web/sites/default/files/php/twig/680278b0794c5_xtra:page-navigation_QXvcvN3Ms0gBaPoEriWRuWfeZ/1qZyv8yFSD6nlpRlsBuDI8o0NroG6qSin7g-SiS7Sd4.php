...
";
            // line 10
            yield from $this->loadTemplate("xtra:page-navigation", "xtra:page-navigation", 10, "361494822")->unwrap()->yield(CoreExtension::merge($context, ["container" => "fixed", "navbar_theme" => "dark", "navbar_expand" => "sm", "navbar_utility_classes" => ["justify-content-between", "border", "border-primary", "border-0", "border-bottom", "border-4"]]));
            // line 46
            yield "
";
            yield from [];
...
/* xtra:page-navigation */
class __TwigTemplate_968a116f7f804557404aee2c800f193f___361494822 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
