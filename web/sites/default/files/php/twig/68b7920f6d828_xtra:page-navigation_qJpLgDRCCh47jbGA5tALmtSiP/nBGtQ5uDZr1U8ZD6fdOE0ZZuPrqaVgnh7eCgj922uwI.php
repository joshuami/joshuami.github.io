...
";
            // line 10
            yield from $this->load("xtra:page-navigation", 10, "63075956")->unwrap()->yield(CoreExtension::merge($context, ["container" => "fixed", "navbar_theme" => "dark", "navbar_expand" => "sm", "navbar_utility_classes" => ["justify-content-between", "border", "border-primary", "border-0", "border-bottom", "border-4"]]));
            // line 46
            yield "
";
            yield from [];
...
/* xtra:page-navigation */
class __TwigTemplate_756772c077a8b54b3a44de2c4f7807e3___63075956 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
