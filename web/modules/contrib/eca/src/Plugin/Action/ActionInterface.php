...
interface ActionInterface {
  ...
  /**
   * Sets the ECA action that executes this action.
   *
   * @param \Drupal\eca\Entity\Objects\EcaAction $action
   *   The ECA action.
   *
   * @return $this
   */
  public function setEcaAction(EcaAction $action): ActionInterface;
