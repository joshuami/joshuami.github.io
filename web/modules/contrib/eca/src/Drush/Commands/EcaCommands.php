...
final class EcaCommands extends DrushCommands {
  ...
  #[CLI\Option(name: 'namespace', description: 'The namespace of the composer package.')]
  #[CLI\Option(name: 'destination', description: 'The directory where to store the recipe.')]
  #[CLI\Usage(name: 'eca:model:export MODELID', description: 'Export the model with the given ID as a recipe.')]
  #[CLI\Usage(name: 'eca:model:export MODELID --namespace=your-vendor', description: 'Customize the recipe namespace (name prefix in composer.json).')]
  #[CLI\Usage(name: 'eca:model:export MODELID --destination=../recipes/process_abc', description: 'Output the recipe at a custom relative path.')]
