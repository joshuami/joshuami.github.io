...
class AgentAction extends AiAssistantActionBase {
  ...
  public function triggerAction(string $action_id, $parameters = []): void {
    ...
    if (empty($defaults)) {
      $this->setOutputContext('ai_agent', 'ERROR: Sorry, the Agents will not work unless you set up a default Chat with Complex JSON model. Please set one up on %link', [
